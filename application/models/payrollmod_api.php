			...
			if($result[0]['count(PR_C_H_NAME)']!=0){
	    		...
	    		if($val_type=='ConditionalFormula'){
		    		...
		    		for($i=0;$i<$val1_count;$i++){
		    			$line_data=array(
			    			'PR_C_L_H_ID'=>$id,
			    			'PR_C_L_CALC_TYPE'=>$_POST['PR_C_L_CALC_TYPE'],
		    		...
		    		$line_data=array(
		    			'PR_C_L_H_ID'=>$id,
		    			'PR_C_L_CALC_TYPE'=>$this->input->post('PR_C_L_CALC_TYPE'),
			...
			if($result[0]['count(PR_G_H_NAME)']!=0){
	    		...
	    		if($val_type=='ConditionalFormula'){
		    		...
		    		for($i=0;$i<$val1_count;$i++){
		    			$line_data=array(
			    			'PR_G_L_H_ID'=>$id,
			    			'PR_G_L_CALC_TYPE'=>$_POST['PR_G_L_CALC_TYPE'],
		    		...
		    		$line_data=array(
		    			'PR_G_L_H_ID'=>$id,
		    			'PR_G_L_CALC_TYPE'=>$this->input->post('PR_G_L_CALC_TYPE'),
