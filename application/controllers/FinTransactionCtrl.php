...
class FinTransactionCtrl extends CI_Controller {
     ...
     function index()
   {
    ...
    function showExpenseView(){
      $this->datatables->select('FINC_TXN_EX_ID, FINC_TXN_EX_TITLE, FINC_TXN_EX_DESC,FINC_TXN_EX_AMT,FINC_TXN_EX_DT,FINC_TXN_EX_STATUS')
      ->from('finance_txn_expense');
      echo $this->datatables->generate();
    }
    function showIncomeView(){
      $this->datatables->select('FINC_TXN_IN_ID, FINC_TXN_IN_TITLE, FINC_TXN_IN_DESC,FINC_TXN_IN_AMT,FINC_TXN_IN_DT,FINC_TXN_IN_STATUS')
