...
`								    <option value="Class2">Class 2</option>
						  ...
						  <div class="row">
							   ...
							   <div class="col-md-8">
							    ...
							    <div class="col-md-2">
								<a style="font-size: 14px;" href="<?php echo base_url('AcademicsC/importSubject');?>" >Import Subjects</a>
							   </div>
						       </div>
						  </div><br>
						  <div class="row">
						  ...
						  <div class="row">
							   ...
							   <div class="col-md-10">
							    ...
							    <div class="col-md-2">
							       <a style="font-size: 14px;" href="<?php echo base_url('AcademicsC/newElective');?>">+ New Elective Group</a>
							   </div>
						       </div>
						  </div>
						  <div class="row">
						  ...
						  <div class="row">
						       <div class="form-group">
							   <div class="col-md-10">
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label style="font-size: 14px;"><a href="<?php echo base_url('AcademicsC/assingnedElective');?>" >Assigned Elective Subjects</a></label>
							   </div>
						       </div>
						 </div>
					      </div>
					     ...
					     <div class="hidden" id="showC1A">
						   ...
						   <div class="row">
							   ...
							   <div class="col-md-8">
							    ...
							    <div class="col-md-2">
								<a style="font-size: 14px;" href="<?php echo base_url('AcademicsC/importsubject1');?>">Import Subjects</a>
							   </div>
						       </div>
						  </div><br>
