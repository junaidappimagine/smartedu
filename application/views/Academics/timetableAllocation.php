	...
	<div id="content" class="content">
	    ...
	    <ol class="breadcrumb pull-right">
		    ...
		    <li class="active">Timetable Allocation</li>
	    </ol>
	    <!-- end breadcrumb -->
	    <!-- begin page-header -->
		...
		<div class="col-md-12">
			...
			<div class="panel-heading">
			    ...
			    <h4 class="panel-title">Timetable Allocation</h4>
			</div>
			<div class="panel-body">
			<legend>Timetable Allocation</legend>
			<div class="form-group row">
			  <div class="col-md-3">
			  <label>December 01, 2016 - November 30, 2017</label>
			  </div>
			  <div class="col-md-3">
			  <a href="<?php echo base_url('AcademicsC/editTimetable');?>" style="cursor: pointer">Edit Timetable</a>
			  </div>
			  <div class="col-md-3"></div>
			  <div class="col-md-3">
			     <a class="btn btn-info btn-sm" style="float: right" href="<?php echo base_url('AcademicsC/timetableSummary');?>">Table Summary</a>
...
$('.down').on('click',function(){
  var data=$(this).addClass('hidden').parents('div.holediv')
  data.find('.dataone').removeClass('hidden')
  data.find('span.up').removeClass('hidden')
}) 
 
 $('.up').on('click',function(){
  var data=$(this).addClass('hidden').parents('div.holediv')
  data.find('.dataone').addClass('hidden')
  data.find('span.down').removeClass('hidden')
}) 
