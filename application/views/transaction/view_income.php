...
<!-- end breadcrumb -->
<!-- begin page-header -->
<h1 class="page-header">Transaction | Add Income</h1>
<!-- end page-header -->
...
<div class="row">
<div class="col-md-4"><a href="<?php echo base_url('FinTransactionCtrl/add_income'); ?>" class="btn btn-primary btn-sm" role="button">Add Income</a></div>
</div><br>
