                                                                                    ...
                                                                                    <tr>
                                                                                        <td>
                                                                                             <div class="checkbox" style="border-bottom: 1px solid #dddddd;">
                                                                                                <label style="margin-left: 38px;"><input type="checkbox" class="check">  BSc - B</label>
                                                                                            </div>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td>
                                                                                             <div class="checkbox" disabled="disabled" style="border-bottom: 1px solid #dddddd;pointer-events: none;opacity:0.5">
                                                                                                <label style="margin-left: 38px;"><input type="checkbox" class="">  BSc - B1</label>
                                                                                            </div>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td>
                                                                                             <div class="checkbox" disabled="disabled" style="border-bottom: 1px solid #dddddd;pointer-events: none;opacity:0.5">
                                                                                                <label style="margin-left: 38px;"><input type="checkbox" class="">  C1 - A</label>
                                                                                            </div>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td>
                                                                                             <div class="checkbox" disabled="disabled" style="border-bottom: 1px solid #dddddd;pointer-events: none;opacity:0.5">
                                                                                                <label style="margin-left: 38px;"><input type="checkbox" class="">  C2 - A</label>
                                                                                            </div>
                                                                                        </td>
                                                                                    </tr>
