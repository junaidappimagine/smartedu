<div id="content" class="content">
        ...
        <div class="panel panel-inverse">
            ...
            <div class="panel-body">
                ...
                <a href="<?php echo base_url('payrollgroup/edit_Payroll');?>"><button type="button" class="btn btn-info btn btn-sm col-sm-offset-10" name="Create_Payroll_group">Edit Payroll</button></a>
                <p><br></p>
