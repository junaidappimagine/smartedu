...
<div id="content" class="content">
        ...
        <!-- begin page-header -->
        <?php if($mode=='View'){?>
            <h1 class="page-header">Change Payroll Group Employees View<small></small></h1>
        <?php }else{?>
            <h1 class="page-header">Change Payroll Group Employees Edit<small></small></h1>
        <?php }?>
        <!-- end page-header -->
        <div class="panel panel-inverse">
            <div class="panel-heading">
                ...
                <?php }else{?>
                    <h4 class="panel-title">Change Payroll Group Employees Edit</h4>
                <?php }?>
            </div>
            <div class="panel-body">
                <div class="container" style="width: 100% !important">
                <?php if($mode=="View"){?>
                    <a href="<?php echo base_url('payrollgroup/change_Payrollgroup_Edit');?>" name="edit" class="btn btn-xs btn-primary col-md-offset-11"><i class="fa fa-edit"></i>Change</a>
                <?php }else{?>
